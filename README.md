...
Sensor python basé sur le client Python permettant d'interroger l'openData du gouvernement sur le prix du carburant
...
Le sensor permet de :
 ...
 - par defaut : actualisation toutes les heures (basé sur l'openData "instantane")
...
- URL : https://github.com/ullrik/prixCarburant-home-assistant
...
# Information sur le sensor et client de base
